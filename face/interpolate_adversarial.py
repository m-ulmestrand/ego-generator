...
from train_adversarial import Decoder
...
def main():
    ...
    decoder.load_state_dict(torch.load(f"./build/{model_name}/{model_name}_decoder.pt"))
    ...
    while plt.fignum_exists(fig.number):
        ...
        output_image = decoder(z).detach().cpu().numpy()[0, 0, :, :]
